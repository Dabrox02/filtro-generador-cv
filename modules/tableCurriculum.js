    ...
    dtRows.forEach((e) => {
        datatable.row
            .add([
                ...
                e.title_user,
                e.description_user,
          /*html*/ `<img src="${e.photo_user ? e.photo_user : imgTmp}" alt="${e.name_user
          ...
          /*html*/ `
            <div class="row justify-content-center">
                ...
                <div class="p-1">
                    <button id="btn-edit-curriculum" class="btn btn-outline-warning" type="button" data-edit="${e.id}" data-toggle="collapse"
                    data-target="#collapseFormCurriculum">Editar</button>
                </div>
                <div class="p-1">
...
export const editCurriculum = async ({ id }) => {
    let res = await curriculum.getOne(id);
    return res;
}